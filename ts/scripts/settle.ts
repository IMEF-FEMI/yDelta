/**
 * `settle.ts` — settle a matured loan (past `matures_at + grace_period`).
 * Same account ordering as `liquidate.ts`; gate is time-only, not LTV.
 * Heavy — 600k CU prepended.
 */
import { PublicKey } from '@solana/web3.js';

import { HEAVY_IX_CU_LIMIT, settleMaturedLoanInstruction } from '../src/index.js';
import {
  bigintFlag,
  flag,
  loadConnection,
