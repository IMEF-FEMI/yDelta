...
/// any account whose `version` field does not match. Version 2 is the
/// current layout: u16 sub-vault ids, SubVault risk/fee fields, a live bid
/// tree, and LTV stamps on `MatchedLoan` / `LoanFixed`.
